  ...
  async (request) => {
    try {
      ...
      const systemPrompt = isNovel
        ? `당신은 베스트셀러 작가입니다. 창의적이고 몰입감 있는 소설을 작성하세요. 절대로 이전 문장을 그대로 반복하지 마십시오. 이야기를 반드시 새로운 국면으로 전개시키십시오. 등장인물의 대사나 행동을 통해 사건을 구체화하십시오. 반드시 [발단-전개-위기-절정-결말]의 5단계 구조를 따르세요. 절정에서는 갈등을 최고조로 끌어올리십시오.${endingInstruction}`
