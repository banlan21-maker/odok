...
### ✅ [v2.1.1] App 번들 크기 (730KB+ gzip 197KB)
...
### ✅ [기구현] 글자 크기 설정 영구 저장
- 확인 결과 이미 Firestore 프로필에 `fontSize` 필드로 저장/복원 구현되어 있음
- 프로필 저장(saveProfile) 시 Firestore 반영, 앱 시작 시 자동 복원
